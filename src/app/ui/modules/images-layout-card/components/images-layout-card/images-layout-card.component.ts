...
@Component({
  ...
  templateUrl: './images-layout-card.component.html',
  styleUrls: ['./images-layout-card.component.css'],
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => ImagesLayoutCardComponent), multi: true }
  ]
})
export class ImagesLayoutCardComponent implements OnInit, ControlValueAccessor {
